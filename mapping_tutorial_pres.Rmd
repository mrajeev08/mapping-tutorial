---
title: "Serology Mapping Tutorial Presentation"
...
```{r echo = FALSE, fig.align='center'}
include_graphics("figs/vector.jpeg")
```
...
```{r echo = FALSE, fig.align='center'}
include_graphics("figs/raster.jpeg")
```
...
```{r echo = FALSE, fig.align='center'}
include_graphics("figs/shapefile.png")
```
